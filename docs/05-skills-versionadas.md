...
| `claude-md-management@claude-plugins-official` | `enabledPlugins` | `claude-md-improver`: auditoria do `AGENTS.md`/`CLAUDE.md`, fase 4 do fluxo do [doc 01](01-contexto-do-projeto.md) |
